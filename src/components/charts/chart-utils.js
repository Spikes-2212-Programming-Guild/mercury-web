export const colorSchemes = {
  'default': {
    name: 'Normal',
    colors: ['rgba(220, 20, 60, 0.8)', 'rgba(46, 139, 87, 0.8)', 'rgba(64, 224, 208, 0.8)', 'rgba(192, 192, 192, 0.8)', 'rgba(255, 218, 185, 0.8)', 'rgba(75, 0, 130, 0.8)']
  },
  'redGreen': {
    name: 'Deutranopia Mode',
    colors: ['rgba(220, 20, 60, 0.8)', 'rgba(255, 215, 0, 0.8)', 'rgba(173, 200, 255, 0.8)', 'rgba(192, 192, 192, 0.8)', 'rgba(244, 164, 96, 0.8)', 'rgba(0, 0, 128, 0.8)']
  },
  'greyScale': {
    name: 'Greyscale',
...
export function generateColors (size) {
  const res = []
  let colors = getColorScheme(localStorage.getItem('schemeNum')).colors
